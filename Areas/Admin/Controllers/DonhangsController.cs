...
namespace HaiStore.Areas.Admin.Controllers
{
    public class DonhangsController : Controller
    {
        ...
        //Thuoc tinh Bind dc sử dụng chỉ định thuộc tính
